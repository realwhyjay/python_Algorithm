...
이분 탐색을 정확히 파악하는걸 넘어서, 자유자재로 풀이에 적용시킬 수 있도록 문제를 많이 풀어봐야할 것 같다 ㅠ

### 참고 사이트

이분탐색의 개념을 이해하기 좋은 설명 : https://wootool.tistory.com/62  
코드를 참고한 블로그 : https://claude-u.tistory.com/443
